...
public partial class SettingsTabManager : Control {
  ...
  #region Nodes
  [NodePath("PanelManager/VBoxContainer/GeneralSettingsPanelContainer")]
  private PanelContainer _generalSettingsPanel = default!;
  [NodePath("PanelManager/VBoxContainer/VideoSettingsPanelContainer")]
  private PanelContainer _videoSettingsPanel = default!;
  [NodePath("PanelManager/VBoxContainer/ControllerSettingsPanelContainer")]
  private PanelContainer _controllerSettingsPanel = default!;
  [NodePath("PanelManager/VBoxContainer/AudioSettingsPanelContainer")]
