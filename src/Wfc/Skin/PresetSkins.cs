...
internal static partial class PresetSkins {
  public static readonly GameSkin DEFAULT_SKIN = new("default",
    [
      ...
      ["00ebff", "ff0085", "a209f6", "ccff00"],
      ["37efff", "ff2597", "ac25f6", "d8ff38"],
      ["5cf1ff", "ff38a0", "b236f6", "dfff5c"],
  ...
  public static readonly GameSkin GOOGL_SKIN = new("googl",
   [
      ...
      ["3eb2ff", "37b057", "ffb831", "e2432e"],
      ["37efff", "49b566", "ffbf45", "e5513d"],
      ["61c0ff", "51bd6f", "ffc454", "eb5a47"],
      ["8cd1ff", "6ec784", "ffd78c", "f29285"]
  ]);
}