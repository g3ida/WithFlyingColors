...
public static class GameSfx {
  ...
  public static readonly Dictionary<string, SfxInfo> Data = new() {
    ...
    ["piano_do"] = new SfxInfo(BASE_PATH + "piano/do.ogg", -3),
    ["piano_re"] = new SfxInfo(BASE_PATH + "piano/re.ogg", -3),
    ["piano_mi"] = new SfxInfo(BASE_PATH + "piano/mi.ogg", -3),
    ["piano_fa"] = new SfxInfo(BASE_PATH + "piano/fa.ogg", -3),
    ["piano_sol"] = new SfxInfo(BASE_PATH + "piano/sol.ogg", -3),
    ["piano_la"] = new SfxInfo(BASE_PATH + "piano/la.ogg", -3),
    ["piano_si"] = new SfxInfo(BASE_PATH + "piano/si.ogg", -3),
