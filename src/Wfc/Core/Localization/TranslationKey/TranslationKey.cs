...
public enum TranslationKey {
  ...
  game_level_title_paint = 90,
  menu_button_credits = 91,
  menu_header_credits = 92,
  credits_section_createdBy = 93,
  credits_section_music = 94,
  credits_section_soundEffects = 95,
  credits_role_designCodeArt = 96,
  credits_section_aiAssistance = 97,
  credits_note_aiAssistance = 98,
  menu_label_slotPlayTime = 99,
  game_hint_readStats = 100,
  menu_tab_gameFacts = 101,
  menu_tab_achievements = 102,
  stats_label_totalTimePlayed = 103,
  stats_label_levelsUnlocked = 104,
  stats_label_totalJumps = 105,
  stats_label_totalDashes = 106,
  stats_label_totalRotateLeft = 107,
  stats_label_totalRotateRight = 108,
  stats_label_totalDeaths = 109,
