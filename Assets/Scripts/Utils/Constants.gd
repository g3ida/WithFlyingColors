...
const DEFAULT_CAMERA_LIMIT_LEFT = -10000
const DEFAULT_CAMERA_LIMIT_RIGHT = 10000
const DEFAULT_CAMERA_LIMIT_TOP = -10000
const DEFAULT_CAMERA_LIMIT_BOTTOM = 10000
