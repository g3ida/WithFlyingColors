...
public partial class Event : Node {
  ...
  public static Event Instance { get => _instance; }
  ...
  public void EmitMenuActionPressed(MenuAction menuAction) => _instance.EmitSignal(nameof(menu_button_pressed), (int)menuAction);
