...
#gems temple
signal gem_temple_triggered()
signal gem_engine_started()
signal level_cleared()
signal gem_put_in_temple()
...
func emit_gem_temple_triggered(): emit_signal("gem_temple_triggered")
func emit_gem_engine_started(): emit_signal("gem_engine_started")
func emit_level_cleared(): emit_signal("level_cleared")
func emit_gem_put_in_temple(): emit_signal("gem_put_in_temple")
