...
namespace Wfc.Entities.Ui.Menubox
{
  ...
  {
    public static SubMenuScene Create(Node instanciator, IEnumerable<ButtonDef> buttons, ColorGroup colorGroup)
    {
      ...
      instanciator.AddChild(instance);
      instance.Owner = instanciator;
      return instance;
    }
  }
}