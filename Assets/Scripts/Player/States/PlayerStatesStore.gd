...
# const PlayerDependencies = preload("res://Assets/Scripts/Player/States/PlayerDependencies.cs")
...
# var slippering_state: PlayerSlipperingState
...
# func _init(player):
#   var dependencies = PlayerDependencies.new()
#   dependencies.Set(player)
...
#   slippering_state = PlayerSlipperingState.new(dependencies)
...
#   if _state == PlayerStatesEnum.SLIPPERING:
